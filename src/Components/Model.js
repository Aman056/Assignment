...
import { closeModal, selectModal } from '../Redux/Slices/ModelSlice';
export default function Model() {
    const { isOpen, messageType } = useSelector(selectModal);
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                    {messageType === 'error' && 'An error occurred. Please try again.'}
                                                    {messageType === 'success' && 'Success message here.'}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
